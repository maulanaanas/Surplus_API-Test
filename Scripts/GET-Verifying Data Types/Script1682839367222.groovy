...
response = WS.sendRequest(findTestObject('GET Data'))
...
def obj = slurper.parseText(response)

assert obj['userId'] instanceof Integer

assert obj['id'] instanceof Integer

assert obj['title'] instanceof String

assert obj['body'] instanceof String
